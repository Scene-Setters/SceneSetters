...
class ShareRoom extends ConsumerStatefulWidget {
  const ShareRoom({
    Key? key, // Remove super.key here
  }) : super(key: key);

  @override
  ConsumerState<ShareRoom> createState() => _ShareRoomState();
}
...
class _ShareRoomState extends ConsumerState<ShareRoom> {
  SizedBox gap() {
